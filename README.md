...
Prerequisite: `install ffmpeg and rcolne in your system`
...
sample command:
`python main.py --yt-link "https://youtu.be/Vi7-Aqc8104?si=15MTQMP80MAt9lQ5" --lang "telugu" --output-dir-name "Death Note"`
